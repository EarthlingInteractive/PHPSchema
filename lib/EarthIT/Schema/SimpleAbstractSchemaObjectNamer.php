...
{
	public abstract function formatName( $name, $plural=false, EarthIT_Schema $s=null );
	
	public function formatTypeName( $name, $plural=false, EarthIT_Schema $s=null ) {
		return $this->formatName( $name, $plural, $s );
	}
	
	public function formatPropertyName( $name, $plural=false, EarthIT_Schema $s=null ) {
		return $this->formatName( $name, $plural, $s );
	}
